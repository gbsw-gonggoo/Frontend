...
function MyPage() {
  ...
  const submitHandler = (e) => {
    setFixClick(!fixClick);
    if(!fixClick||(nickname===user.nickname&&email===user.email)) return false;
  ...
  return (
    <div className="w-full h-full lg:fixed bg-slate-50">
      <div className="w-full h-full mx-auto flex flex-col items-center lg:max-w-7xl lg:px-16 relative lg:overflow-y-hidden">
